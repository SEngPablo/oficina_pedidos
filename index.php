    ...
    >
        ...
        <tbody>
            ...
            <tr class="">
                ...
                <td>Cadeira</td>
                <td>R$55,00</td>
                <td>                    <a name="editar" id="editar" class="btn btn-warning" href="#" role="button">Editar</a>
                    <a name="excluir" id="excluir" class="btn btn-danger" href="#" role="button">Excluir</a></td>
            </tr>
        </tbody>
    </table>
</div>
